...
evaluate(model, testloader, device=device, adv='FGM')
evaluate(model, testloader, device=device, adv='CW')
for i in iters:
    evaluate(model, testloader, device=device, adv='PGD', n_iter=i)
for e in epss:
    evaluate(model, testloader, device=device, adv='SPSA', n_iter=5, eps=e)
